...
$classes = ($active ?? false)
            ? 'flex items-center gap-3 px-4 py-3 rounded-xl bg-amber-600 text-white font-bold transition-all shadow-xl shadow-amber-600/60 border border-amber-400/30'
